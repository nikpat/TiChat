...
// in simulator we redefine to format for NeoChat Developer console
...
{\
	NSString * exceptionName = [@"org.neochat." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.neochat";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UINeoChatNativeItemNone = -1, 
	UINeoChatNativeItemSpinner = -2,
	UINeoChatNativeItemProgressBar = -3,
	
	UINeoChatNativeItemSlider = -4,
	UINeoChatNativeItemSwitch = -5,
	UINeoChatNativeItemMultiButton = -6,
	UINeoChatNativeItemSegmented = -7,
	
	UINeoChatNativeItemTextView = -8,
	UINeoChatNativeItemTextField = -9,
	UINeoChatNativeItemSearchBar = -10,
	
	UINeoChatNativeItemPicker = -11,
	UINeoChatNativeItemDatePicker = -12,
	
	UINeoChatNativeItemInfoLight = -13,
	UINeoChatNativeItemInfoDark = -14,
	
	UINeoChatNativeItemDisclosure = -15,
	
	UINeoChatNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all NeoChat instances of
