 ...
 * Copyright (c) 2009-2012 by NeoChat, Inc. All Rights Reserved.
...
//@interface NeoChatObject : NSObject
//@end

@interface NeoChatObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[NeoChatObject class]])
		{
			for (NSString *key in [[(NeoChatObject*)o modules] allKeys])
			{
